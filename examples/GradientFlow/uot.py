...
import torch
from sparse_ot.uot_mmd import solve_apgd, get_obj
from sparse_ot.utils import get_dist, get_G
...
parser.add_argument('--khp', type=float, default=0.001)
...
for i in range(Nsteps):
    ...
    with torch.no_grad():
        pi = solve_apgd(C, G1, G2, a_i, b_j, max_itr, lda)
    obj = get_obj(C, {1: G1, 2: G2}, lda, {1: a_i, 2: b_j}, pi)
